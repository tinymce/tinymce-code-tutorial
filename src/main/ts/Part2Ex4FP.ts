...
// Answer: The array is kept as is. A shallow copy may be made depending on context.
...
const getOrElse4 = <A> (oa: Optional<A>, other: A): A =>
  oa.fold(
    Fun.constant(other),
    Fun.identity
  );
...
const arrSetNine = (arr: number[]): number[] => 
...
const doubleDouble = Fun.compose1(dbl, dbl)
